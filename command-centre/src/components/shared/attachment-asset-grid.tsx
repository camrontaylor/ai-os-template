  ...
  return (
    <div
      style={{
        ...
        background:
          item.status === "failed"
            ? "linear-gradient(180deg, color-mix(in srgb, var(--card) 96%, transparent), color-mix(in srgb, var(--card) 94%, transparent))"
            : "linear-gradient(180deg, color-mix(in srgb, var(--card) 98%, transparent), color-mix(in srgb, var(--card) 96%, transparent))",
        display: "flex",
    ...
    >
      ...
      <span
        style={{
          ...
          lineHeight: 1.35,
          fontFamily: MONO,
          color: item.status === "failed" ? "var(--destructive)" : "var(--muted-foreground)",
          overflow: "hidden",
  ...
  return (
    <div
      style={{
        ...
        minHeight: compact ? 64 : 76,
        borderRadius: 10,
        background: "linear-gradient(180deg, color-mix(in srgb, var(--card) 98%, transparent), color-mix(in srgb, var(--card) 96%, transparent))",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        justifyContent: "center",
...
function PdfAttachmentPreviewFrame({
      ...
      >
        <img
          ...
          style={{
            ...
            boxShadow: "0 10px 26px color-mix(in srgb, var(--foreground) 12%, transparent)",
          }}
        />
      </div>
    );
  ...
  return <AttachmentPreviewFallback item={item} compact={compact} accentColor="var(--primary)" />;
}
...
function AttachmentPreviewFrame({
  ...
  return <AttachmentPreviewFallback item={item} compact={compact} accentColor="var(--muted-foreground)" />;
}
    ...
    const media = isImage && previewUrl ? (
      <img
        ...
        style={{
          ...
          objectFit: "contain",
          borderRadius: 18,
          boxShadow: "0 18px 48px color-mix(in srgb, var(--foreground) 28%, transparent)",
        }}
      />
      ...
      <div
        style={{
          ...
          borderRadius: 22,
          background: "linear-gradient(180deg, color-mix(in srgb, var(--card) 98%, transparent), color-mix(in srgb, var(--card) 96%, transparent))",
          boxShadow: "0 18px 48px color-mix(in srgb, var(--foreground) 24%, transparent)",
        }}
      >
        <img
          src={pdfPreview.imageUrl}
            ...
            <div style={{ minWidth: 0 }}>
              <div
                style={{
                  ...
                  fontFamily: MONO,
                  color: "color-mix(in srgb, var(--card) 74%, transparent)",
                }}
              >
...
export function AttachmentAssetCard({
  ...
  const accentColor = item.status === "failed" ? "var(--destructive)" : "var(--primary)";
    ...
    <>
      <div
        ...
        style={{
          ...
          borderRadius: 12,
          border: showActions
            ? `1px solid ${item.status === "failed" ? "color-mix(in srgb, var(--foreground) 28%, transparent)" : "color-mix(in srgb, var(--foreground) 28%, transparent)"}`
          ...
          boxShadow: showActions
            ? "0 8px 24px color-mix(in srgb, var(--foreground) 8%, transparent)"
            : "0 1px 4px color-mix(in srgb, var(--foreground) 4%, transparent)",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
          <span
            style={{
              ...
              borderRadius: 999,
              backgroundColor:
                item.status === "failed" ? "color-mix(in srgb, var(--foreground) 12%, transparent)" : "color-mix(in srgb, var(--foreground) 8%, transparent)",
              fontSize: 10,
              fontWeight: 700,
              letterSpacing: "0.08em",
              color: item.status === "failed" ? "var(--destructive)" : "var(--muted-foreground)",
          ...
          {onRemoveItem ? (
            <button
              ...
              style={{
                ...
                borderRadius: 999,
                border: "none",
                backgroundColor: showActions ? "color-mix(in srgb, var(--foreground) 8%, transparent)" : "transparent",
                color: item.status === "failed" ? "var(--destructive)" : "var(--muted-foreground)",
                cursor: "pointer",
                flexShrink: 0,
              }}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          >
            ...
            {item.status === "uploading" ? (
              <LoaderCircle size={13} style={{ color: "var(--primary)", animation: "spin 1s linear infinite" }} />
            ) : null}
  ...
  return (
    <div
      style={{
        ...
        gap: 8,
        flexWrap: "wrap",
        padding: padding ?? (compact ? "4px 8px" : "4px 12px 8px"),
      }}
    >
      {items.map((item) => (
        <AttachmentAssetCard
