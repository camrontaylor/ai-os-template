    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 12,
          boxShadow: "0px 24px 56px color-mix(in srgb, var(--foreground) 22%, transparent)",
          zIndex: 301,
          display: "flex",
  ...
  return (
    <button
      ...
      style={{
        ...
        border: secondary ? "1px solid color-mix(in srgb, var(--foreground) 35%, transparent)" : "none",
        borderRadius: 6,
        ...
        color: secondary ? MUTED : "var(--card)",
      ...
      >
        <button
          ...
          style={{
            ...
            fontFamily: FONT_SG,
            fontWeight: 500,
            color: isFirst ? "var(--border)" : MUTED,
            background: "none",
            border: "none",
...
function SteppedQuestionField({
  ...
  const label = (
    ...
    >
      <span style={{ color: ACCENT, marginRight: 8, fontWeight: 700 }}>
        {index + 1}.
      </span>
      {question.prompt}
      {question.required && (
