        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              border: "none",
              background: selectedClientId === null ? "var(--muted)" : "transparent",
              cursor: "pointer",
              fontFamily: "var(--font-inter), Inter, sans-serif",
              fontSize: 13,
              color: selectedClientId === null ? "var(--foreground)" : "var(--muted-foreground)",
              transition: "background 150ms ease",
            }}
            onMouseEnter={(e) => {
              if (selectedClientId !== null) e.currentTarget.style.backgroundColor = "var(--muted)";
            }}
            onMouseLeave={(e) => {
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, flex: 1 }}>
              <Globe size={16} style={{ color: selectedClientId === null ? "var(--foreground)" : "var(--muted-foreground)" }} />
          ...
          {clients.map((client) => (
            <button
              ...
              style={{
                ...
                borderRadius: 6,
                border: "none",
                background: selectedClientId === client.slug ? "var(--muted)" : "transparent",
                cursor: "pointer",
                fontFamily: "var(--font-inter), Inter, sans-serif",
                fontSize: 13,
                color: selectedClientId === client.slug ? "var(--foreground)" : "var(--muted-foreground)",
                transition: "background 150ms ease",
              }}
              onMouseEnter={(e) => {
                if (selectedClientId !== client.slug) e.currentTarget.style.backgroundColor = "var(--muted)";
              }}
              onMouseLeave={(e) => {
