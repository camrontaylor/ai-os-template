            ...
            <>
              {taskCreated ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, padding: "20px 0" }}>
                  <Check size={40} color="var(--muted-foreground)" />
                  <p
                    style={{
                      fontFamily: "var(--font-inter), Inter, sans-serif",
                      fontSize: 15,
                ...
                <>
                  ...
                  <textarea
                    ...
                    onBlur={(e) => { e.currentTarget.style.borderColor = "color-mix(in srgb, var(--foreground) 30%, transparent)"; }}
                  />
                  ...
                  >
                    <span style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <Link size={12} />
                      Reference URL
                      <span style={{ fontWeight: 400, textTransform: "none", letterSpacing: 0, color: "var(--muted-foreground)" }}>(optional)</span>
                    </span>
                  </label>
                  <input
                    type="url"
                  ...
                  {error && (
                    ...
                    >
                      <AlertCircle size={16} color="var(--destructive)" style={{ flexShrink: 0 }} />
                      <span style={{ fontSize: 12, color: "var(--destructive)", fontFamily: "var(--font-inter), Inter, sans-serif" }}>
                        {error}
                      </span>
                    </div>
                  )}
              ...
              {uploadedFiles.length > 0 ? (
                ...
                <>
                  ...
                  <div
                    ...
                    style={{
                      border: `2px dashed ${isDragging ? "var(--primary)" : "color-mix(in srgb, var(--foreground) 40%, transparent)"}`,
                      borderRadius: 12,
                      padding: "40px 24px",
                      textAlign: "center",
                      cursor: uploading ? "wait" : "pointer",
                      backgroundColor: isDragging ? "color-mix(in srgb, var(--foreground) 4%, transparent)" : "transparent",
                  ...
                  >
                    {uploading ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                        <FolderUp size={36} color={isDragging ? "var(--primary)" : "var(--border)"} />
                        <span
                          style={{
                            fontSize: 14,
