    ...
    return (
      <div key={node.path}>
        <button
          ...
          onMouseEnter={(e) => {
            if (!isSelected && !isDragOver) e.currentTarget.style.background = "var(--muted)";
          }}
          onMouseLeave={(e) => {
        ...
        >
          {isDir ? (
            isExpanded ? (
              ...
              <Folder size={16} style={{ color: isDragOver ? "var(--primary)" : "var(--muted-foreground)", flexShrink: 0 }} />
            )
          ) : (
            (() => {
    ...
    return (
      <button
        ...
        style={{
          ...
          padding: "8px 12px",
          border: "none",
          background: isDragOverFolder ? "color-mix(in srgb, var(--foreground) 8%, transparent)" : "transparent",
          ...
          textAlign: "left",
          transition: "background 150ms ease",
          outline: isDragOverFolder ? "2px dashed var(--primary)" : "none",
          outlineOffset: -2,
          opacity: isSectionDragging ? 0.4 : 1,
          borderTop: isSectionDragOver && !isSectionDragging ? "2px solid var(--primary)" : "2px solid transparent",
        }}
        onMouseEnter={(e) => {
          if (!isDragOverFolder) e.currentTarget.style.background = "var(--muted)";
        }}
        onMouseLeave={(e) => {
      ...
      >
        {isExpanded ? (
          ...
          <Folder size={16} style={{ color: isDragOverFolder ? "var(--primary)" : "var(--muted-foreground)", flexShrink: 0 }} />
        )}
    ...
    return (
      <div
        ...
        style={{
          ...
          borderTop: isNodeDragOver ? "2px solid var(--primary)" : "2px solid transparent",
          cursor: "grab",
        }}
      >
        {renderNode(node, 1)}
  ...
  if (!hasContent) {
    return (
      <div style={{ padding: 24, textAlign: "center" }}>
        <FileText size={32} style={{ color: "var(--muted-foreground)", margin: "0 auto 8px" }} />
        <p style={{ fontFamily: "var(--font-inter), Inter, sans-serif", fontSize: 13, color: "var(--muted-foreground)" }}>
                  ...
                  <div key={client.slug}>
                    ...
                    >
                      {isExpanded ? (
                        ...
                        <Folder size={16} style={{ color: "var(--muted-foreground)", flexShrink: 0 }} />
                      )}
                      <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1 }}>
                        {client.name}
                      </span>
