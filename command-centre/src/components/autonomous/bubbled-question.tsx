...
const FONT_SG = "var(--font-inter), Inter, sans-serif";
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
        <MessageCircleQuestion size={13} style={{ color: "var(--muted-foreground)" }} />
        <span
          style={{
            fontSize: 10,
            fontWeight: 600,
      ...
      {useStepper && (
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            ...
            {specs.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 3,
                  border: "none",
                  backgroundColor: i === step ? ACCENT : "color-mix(in srgb, var(--foreground) 20%, transparent)",
          ...
          <span style={{ fontSize: 10, fontFamily: FONT_SG, color: "var(--muted-foreground)" }}>
            {step + 1} of {total}
          </span>
        </div>
      )}
          ...
          {isLast ? (
            <button
              ...
              style={{
                ...
                border: "none",
                borderRadius: 6,
                backgroundColor: canSubmit ? ACCENT : "color-mix(in srgb, var(--foreground) 15%, transparent)",
      ...
      {submitted && (
        <div style={{ marginTop: 8, fontSize: 11, fontFamily: FONT_SG, color: "var(--muted-foreground)", fontWeight: 500 }}>
          Answers submitted
        </div>
      )}
    </div>
...
function ChipQuestionField({
  ...
  const label = (
    <div style={{ fontSize: 12, color: "var(--foreground)", lineHeight: 1.4, marginBottom: 8, fontWeight: 500, fontFamily: FONT }}>
      <span style={{ color: ACCENT, marginRight: 4, fontWeight: 700 }}>{index + 1}.</span>
      {question.prompt}
      {question.required && <span style={{ color: ACCENT, marginLeft: 4 }}>*</span>}
    </div>
  );
        ...
        {isMultiline ? (
          <textarea
            ...
            style={{
              ...
              backgroundColor: "var(--card)", resize: "vertical", lineHeight: 1.4,
              minHeight: 40, maxHeight: 100, boxSizing: "border-box", color: "var(--foreground)",
            }}
          />
        ) : (
          <input
            ...
            style={{
              width: "100%", padding: "8px 12px", fontSize: 12, fontFamily: FONT,
              border: "1px solid var(--border)", borderRadius: 6, outline: "none",
              backgroundColor: "var(--card)", color: "var(--foreground)", boxSizing: "border-box",
            }}
          />
        )}
      </div>
          ...
          return (
            <button
              ...
              style={{
                ...
                backgroundColor: isChecked ? ACCENT : "var(--card)",
                color: isChecked ? "var(--card)" : "var(--foreground)",
                border: isChecked
                  ? `1px solid ${ACCENT}`
                  : isFocused
                ...
                outline: isFocused && !isChecked ? "1px solid color-mix(in srgb, var(--foreground) 20%, transparent)" : "none",
                outlineOffset: 1,
              }}
            >
              {opt}
      ...
      {!showReply ? (
        ...
        <div
          ...
          style={{
            ...
            gap: 8,
            marginTop: 4,
            border: composer.isDragging ? "1px solid var(--border)" : "none",
            borderRadius: 8,
            padding: composer.isDragging ? 8 : 0,
          }}
        >
          {hasAssets ? (
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              border: "none",
              backgroundColor: composer.message.trim() || composer.attachments.length > 0 ? ACCENT : "color-mix(in srgb, var(--foreground) 15%, transparent)",
              color: composer.message.trim() || composer.attachments.length > 0 ? "var(--card)" : "var(--muted-foreground)",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <button
              ...
              style={{
                ...
                color: composer.isUploading ? "var(--border)" : "var(--muted-foreground)",
