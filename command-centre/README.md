...
- The AI-OS workspace root is the repository root containing `AGENTS.md` or, on the current `dev` branch, `CLAUDE.md`.
- `AI_OS_DIR` is optional. If it is unset, the launcher and runtime auto-detect the workspace root.
