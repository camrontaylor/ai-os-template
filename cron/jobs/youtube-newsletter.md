...
notify: on_finish
description: >-
  Check @your-youtube-channel for new videos and generate a newsletter from the
  transcript
---
You are running as a scheduled cron job for AI-OS.

## Task

Check the YouTube channel @your-youtube-channel for any new video uploads. If a new video is found, generate a newsletter from the transcript and save it.
...
```bash
uv run .claude/skills/tool-youtube/scripts/digest.py --channels "@your-youtube-channel" --hours 48 --max-videos 3 --seen-file cron/status/youtube-newsletter-seen.txt
```
