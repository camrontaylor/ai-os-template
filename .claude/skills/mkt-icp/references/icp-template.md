...
Exact format for `brand_context/icp.md`. All sections required.
...
| Alternative | Why it didn't work | What they learned |
|------------|-------------------|-------------------|
| {Alternative 1} | {Specific frustration} | {Insight or objection it created} |
| {Alternative 2} | {Specific frustration} | {Insight or objection it created} |
| {Alternative 3} | {Specific frustration} | {Insight or objection it created} |

**Sophistication level:** {Beginner (first time solving this) / Intermediate (tried 1-2 things) / Advanced (tried everything, skeptical)}
...
| Objection | What's really behind it | How to address |
|-----------|------------------------|----------------|
| "{Objection 1 in their words}" | {The real concern} | {Proof or framing that resolves it} |
| "{Objection 2}" | {The real concern} | {Proof or framing} |
| "{Objection 3}" | {The real concern} | {Proof or framing} |
...
| Platform/Channel | How they use it | Why it matters |
|-----------------|----------------|---------------|
| {Platform 1} | {What they do there} | {Best channel for reaching them} |
| {Platform 2} | {What they do there} | {Opportunity} |
| {Platform 3} | {What they do there} | {Opportunity} |

**People they trust:** {Influencers, publications, communities they follow}
