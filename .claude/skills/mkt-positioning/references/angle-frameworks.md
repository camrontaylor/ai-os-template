...
Eight frameworks for generating positioning angles. Run the product through several and keep the 3-5 strongest options.

---

## 1. The Contrarian Angle

Challenge what everyone in the market believes.
...
## 2. The Unique Mechanism Angle

Lead with HOW it works differently, not just WHAT it does.
...
Before and after. The gap between current pain and desired outcome.
...
**Works when:** Audience has shared frustrations. There's a clear villain to rally against. Creates an us-vs-them dynamic that bonds brand to audience.

**Good enemies:** Complexity, gatekeepers, outdated methods, the status quo, misinformation, unnecessary middlemen.

---

## 5. The Speed/Ease Angle

Compress the time or reduce the effort required.
...
**Works when:** Have strong proof. Market is skeptical. Trust is the primary barrier. The proof is specific and verifiable.

**Hierarchy of proof (strongest to weakest):** Named case studies with numbers → aggregate statistics → expert endorsements → user testimonials → social signals (follower count, press mentions).

---

## 8. The Risk Reversal Angle
...
The strongest angles often combine two frameworks:

- **Mechanism + Transformation:** "The [Named Method] that takes you from [before] to [after]"
- **Specificity + Enemy:** "For [specific avatar] who are tired of [enemy]"
- **Contrarian + Proof:** "Everyone says [common belief]. Here's what [number] of our customers found instead."
- **Speed + Risk Reversal:** "[Outcome] in [time] or [consequence]"

When generating angles, try at least 2-3 combinations alongside pure single-framework angles.
