...
description: >
  ...
  "deep brand voice", "playbook mode", "brand voice playbook".
...
> "Quick setup (5-8 targeted questions, ~5 min) or the full Brand Voice Playbook (deeper interview, ~10-15 min, better for people starting from zero)?"
